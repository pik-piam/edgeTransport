...
if (Standalone_mode == TRUE){
  ...
  data_extended <- lvl2_generate_plotdata(listofruns=listofruns[8:11], load_Cache=load_Cache, cache_folder="cache", AggrReg="H12")
...
if (Standalone_mode == TRUE){
  ...
  lineplot(varname = "shareweight trend S3S", data= plotdata)
