...
for (scen0 in scen) {
  ...
  p2 <- mipBarYearData(plotdata[period %in% c(2010,2020, 2030, 2050)],ylab="Prices logit_S3S [USD2005/pkm]")
  print(p2)}
...
for (scen0 in scen) {
  ...
  p2 <- mipBarYearData(plotdata[period %in% c(2010,2020, 2030, 2050)],ylab="Prices logit_S1S2 [USD2005/pkm]")
  print(p2)}
...
for (scen0 in scen) {
  ...
  p2 <- mipBarYearData(plotdata[period %in% c(2010,2020, 2030, 2050)],ylab="Prices logit_VS1 [USD2005/pkm]")
  print(p2)}
