...
demandEJ_IEAcomp <- function(demandEJ, IEA, demEJ_TRACCS){
  ...
  totdem_road=rbind(demandEJ[year %in% c(2005, 2010, 2015)], IEA[year %in% c(2005, 2010, 2015)], demEJ_TRACCS)
...
plots = demandEJ_IEAcomp(demand_ej, IEA, demEJ_TRACCS)
