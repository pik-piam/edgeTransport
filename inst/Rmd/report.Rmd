...
plotVintTruckBus = function(vintcomp, newcomp, sharesVS1, loadFactor){
  ...
  ## Add electric and FCEV trucks mileage
  annual_mileage_trucks <- rbindlist(list(
    annual_mileage,
    annual_mileage[subsector_L3 == "trn_freight_road" & technology == "Liquids"][, technology := "Electric"],
    annual_mileage[subsector_L3 == "trn_freight_road" & technology == "Liquids"][, technology := "FCEV"],
    annual_mileage[subsector_L2 == "Bus" & technology == "Liquids"][, technology := "Electric"],
    annual_mileage[subsector_L2 == "Bus" & technology == "Liquids"][, technology := "FCEV"]))
  
  allfleet = merge(allfleet, annual_mileage_trucks, by = c("region", "year", "sector", "subsector_L1", "vehicle_type", "technology"))
  ...
  allfleet = allfleet[,.(value = sum(value/loadFactor/vkm.veh)), by = c("region", "technology", "variable", "year", "subsector_L1")]
