...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
plotVintTruckBus = function(vintcomp, newcomp, sharesVS1, loadFactor, annual_mileage){
  vint = copy(vintcomp)
  new = copy(newcomp)
...
p = plotVintTruckBus(vintcomp, newcomp, sharesVS1 = shares$VS1_shares, loadFactor, annual_mileage)
p
```
