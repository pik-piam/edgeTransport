...
```{r}
tot <- "FE|Transport|Bunkers|Bunkers|Freight|International Shipping"
showLinePlots(data, tot)
```
...
```{r}
tot <- "FE|Transport|Bunkers|Bunkers|Freight|International Shipping|Liquids"

items <- c(
    "FE|Transport|Bunkers|Bunkers|Freight|International Shipping|Liquids|Fossil",
    "FE|Transport|Bunkers|Bunkers|Freight|International Shipping|Liquids|Hydrogen",
    "FE|Transport|Bunkers|Bunkers|Freight|International Shipping|Liquids|Biomass"
  )
showAreaAndBarPlots(data, items, tot,  orderVars = "user")
walk(items, showLinePlots, data = data)
```
...
items <- c(
      "FE|Transport|Bunkers|Bunkers|Freight|International Shipping",
