...
walk(c(items,"Emi|CO2|Transport|Pass|Road|LDV|Tailpipe"), showLinePlots, data = data)
```
...
items <- c(
      "Emi|CO2|Transport|Bunkers|Bunkers|Freight|International Shipping|Tailpipe",
