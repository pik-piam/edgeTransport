...
items <- c(
      ...
      "Emi|CO2|Transport|Pass|Rail|non-HSR|Tailpipe",
...
showAreaAndBarPlots(data, items[2:7], tot, orderVars = "user")
showAreaAndBarPlots(data, items[2:7], tot, fill = TRUE, orderVars = "user")
...
items <- c(
      "Emi|CO2|Transport|Freight|International Shipping",
      "Emi|CO2|Transport|Freight|Navigation",
      "Emi|CO2|Transport|Freight|Rail",
      "Emi|CO2|Transport|Freight|Road"
  )
