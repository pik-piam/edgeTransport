...
items <- c(
  ...
  "UE|Transport|w/o bunkers|Gases",
...
items <- c(
  ...
  "UE|Transport|Pass|w/o bunkers|Gases",
...
```{r}
items <- c(
  # "UE|Transport|Pass|Aviation|International",
  # "UE|Transport|Pass|Aviation|Domestic",
