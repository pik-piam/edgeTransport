...
toolApplyICEbanOnPreferences <- function(preferenceTab, helpers, years) {
  ...
  preferenceTab[level == "FV" & region %in% affectedRegions & (subsectorL1 == "trn_freight_road" | subsectorL2 == "Bus") & technology %in% c("Liquids", "Gases"),
             value := ifelse(period == 2025 & period %in% years, 0.98 * value[period == 2015], value), by = c("region", "technology")]
  preferenceTab[level == "FV" & region %in% affectedRegions & (subsectorL1 == "trn_freight_road" | subsectorL2 == "Bus") & technology %in% c("Liquids", "Gases"),
             value := ifelse(period == 2030 & period %in% years, 0.75 * value[period == 2015], value), by = c("region", "technology")]
  preferenceTab[level == "FV" & region %in% affectedRegions & (subsectorL1 == "trn_freight_road" | subsectorL2 == "Bus") & technology %in% c("Liquids", "Gases"),
             value := ifelse(period == 2035 & period %in% years, 0.3 * value[period == 2015], value), by = c("region", "technology")]
  preferenceTab[level == "FV" & region %in% affectedRegions & (subsectorL1 == "trn_freight_road" | subsectorL2 == "Bus") & technology %in% c("Liquids", "Gases"),
             value := ifelse(period == 2040 & period %in% years, 0.2 * value[period == 2015], value), by = c("region", "technology")]
  preferenceTab[level == "FV" & region %in% affectedRegions & (subsectorL1 == "trn_freight_road" | subsectorL2 == "Bus") & technology %in% c("Liquids", "Gases"),
             value := ifelse(period == 2045 & period %in% years, 0.1  * value[period == 2015], value), by = c("region", "technology")]
  preferenceTab[level == "FV" & region %in% affectedRegions & (subsectorL1 == "trn_freight_road" | subsectorL2 == "Bus") & technology %in% c("Liquids", "Gases"),
             value := ifelse(period > 2045 & period %in% years, value * 0.05, value), by = c("region", "technology")]
