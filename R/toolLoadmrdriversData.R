...
toolLoadmrdriversData <- function(SSPscen, helpers) {
  ...
  GDPMERmag <- GDPMERmag[, , paste0("gdp_", SSPscen)] |> magclass::time_interpolate(years)
  ...
  GDPpcMERmag <- GDPpcMERmag[, , paste0("gdppc_", SSPscen)] |> magclass::time_interpolate(years)
  ...
  GDPpppMag <- GDPpppMag[, , paste0("gdp_", SSPscen)] |> magclass::time_interpolate(years)
  ...
  GDPpcPPPmag <- GDPpcPPPmag[, , paste0("gdppc_", SSPscen)] |> magclass::time_interpolate(years)
  ...
  POPmag <- calcOutput("Population", aggregate = TRUE,
                       regionmapping = "regionmapping_21_EU11.csv")[, , paste0("pop_", SSPscen)] |> magclass::time_interpolate(years)
