...
Hybrid Electric,Liquids")
    ...
    if(tech_scen %in% c("PhOP", "Mix3", "Mix4", "ECEMF_HighEl_ModEff", "ECEMF_HighEl_HighEff", "ECEMF_HighEl_LifestCha", "ECEMF_HighH2_ModEff", "ECEMF_HighH2_HighEff", "ECEMF_HighH2_LifestCha")){
      browser()
