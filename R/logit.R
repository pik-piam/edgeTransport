...
toolCalculateLogitIncost <- function(prices,
  ...
  for (t in futyears_all[futyears_all>2020]) {
    ...
    if(tech_scen %in% c("PhOP", "Mix3", "Mix4", "ECEMF_HighEl_ModEff", "ECEMF_HighEl_HighEff", "ECEMF_HighEl_LifestCha", "ECEMF_HighH2_ModEff", "ECEMF_HighH2_HighEff", "ECEMF_HighH2_LifestCha") & t>= 2030){
