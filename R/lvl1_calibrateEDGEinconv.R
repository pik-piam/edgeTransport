...
lvl1_calibrateEDGEinconv <- function(prices, GCAM_data, logit_exp_data, vot_data, price_nonmot){
  ...
  FV_final_SW=FV_SW[,.(iso,year,technology,tot_price,vehicle_type,subsector_L1,subsector_L2,subsector_L3,sector,sw,logit.exponent)]
  ...
  ## reshape, save and store the sw at this level
  VS1_final_SW=VS1_SW[,.(iso,year,vehicle_type,subsector_L1,subsector_L2,subsector_L3,sector,sw,tot_price,logit.exponent)]
  ...
  ## reshape, save and store the sw at this level
  S1S2_final_SW=S1S2_sw[,.(iso,year,subsector_L1,subsector_L2,subsector_L3,sector,sw,tot_price,logit.exponent)]
  ...
  ## reshape, save and store the sw at this level
  S2S3_final_SW=S2S3_sw[,.(iso,year,subsector_L2,subsector_L3,sector,sw, tot_price, logit.exponent)]
  ...
  ## reshape, save and store the sw at this level
  S3S_final_SW=S3S_sw[,.(iso,year,subsector_L3,sector,sw,tot_price,logit.exponent)]
