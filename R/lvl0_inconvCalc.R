...
lvl0_incocost <- function(annual_mileage, load_factor, fcr_veh){
  ...
  pinco[year >= 2010 & technology == "Hybrid Liquids", pmod_av := (pmod_av[year==2010]-29150*fcr_veh)/(2010-2020)*(year-2010)+pmod_av[year==2010], by = c("region", "technology", "sector", "subsector_L3", "subsector_L2", "subsector_L1","vehicle_type")]
