...
`
generateEDGEdata(input_folder, output_folder, SSP_scen = "SSP2", transportPolScen = NULL, IEAbal = NULL, GDP_country = NULL, POP_country = NULL, trsp_incent = NULL, RatioPPP2MER_country = NULL, JRC_IDEES_Trsp = NULL, JRC_IDEES_MarBunk = NULL, storeRDS = FALSE)
`
...
`transportPolScen` character string containing the EDGE-T technology scenario, if provided. By default, SSP/SDP "coherent" technology development is selected. Hybrid matches SSP-technology scenario (e.g. SSP2 with high hydrogen demand) are allowed.
