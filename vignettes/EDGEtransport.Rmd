...
`
generateEDGEdata(input_folder, output_folder, mappings_folder, REMIND_gdx, EDGE_scenario, REMIND_scenario, saveRDS = FALSE)
`
...
`REMIND_gdx` character string containing the path a previous gdx output from REMIND
