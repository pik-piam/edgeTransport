...
R package **edgeTransport**, version **3.1.0**
...
Hoppe J, Dirnaichner A, Rottoli M, Muessel J, Hagen A, Pietzcker R (2025). "edgeTransport: Prepare EDGE Transport Data for the REMIND model - Version 3.1.0."

A BibTeX entry for LaTeX users is

 ```latex
@Misc{,
  title = {edgeTransport: Prepare EDGE Transport Data for the REMIND model - Version 3.1.0},
