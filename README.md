...
R package **edgeTransport**, version **1.5.4**
...
Dirnaichner A, Rottoli M, Hoppe J (2024). _edgeTransport: Prepare EDGE Transport Data for the REMIND model_. R package version 1.5.4, <URL: https://github.com/pik-piam/edgeTransport>.
