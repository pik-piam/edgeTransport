...
R package **edgeTransport**, version **0.29.0**
...
Dirnaichner A, Rottoli M, Hoppe J (2023). _edgeTransport: Prepare EDGE Transport Data for the REMIND model_. R package version 0.29.0, <https://github.com/pik-piam/edgeTransport>.
