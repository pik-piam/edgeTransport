...
R package **edgeTransport**, version **2.6.2.9001**
...
Hoppe J, Dirnaichner A, Rottoli M, Muessel J (2024). _edgeTransport: Prepare EDGE Transport Data for the REMIND model_. R package version 2.6.2.9001, <https://github.com/pik-piam/edgeTransport>.
...
@Manual{,
  ...
  year = {2024},
  note = {R package version 2.6.2.9001},
