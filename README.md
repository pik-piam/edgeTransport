...
R package **edgeTransport**, version **1.5.5.9013**
...
Hoppe J, Dirnaichner A, Rottoli M, Muessel J (2024). _edgeTransport: Prepare EDGE Transport Data for the REMIND model_. R package version 1.5.5.9013, <https://github.com/pik-piam/edgeTransport>.
