...
R package **edgeTransport**, version **2.9.0**
...
Hoppe J, Dirnaichner A, Rottoli M, Muessel J (2024). _edgeTransport: Prepare EDGE Transport Data for the REMIND model_. R package version 2.9.0, <https://github.com/pik-piam/edgeTransport>.
