...
R package **edgeTransport**, version **3.12.1**
...
Hoppe J, Dirnaichner A, Rottoli M, Muessel J, Hagen A, Pietzcker R (2026). "edgeTransport: Prepare EDGE Transport Data for the REMIND model." Version: 3.12.1, <https://github.com/pik-piam/edgeTransport>.
