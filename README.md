...
R package **edgeTransport**, version **1.5.5.9005**
...
Hoppe J, Dirnaichner A, Rottoli M, Muessel J (2024). _edgeTransport: Prepare EDGE Transport Data for the REMIND model_. R package version 1.5.5.9005, <https://github.com/pik-piam/edgeTransport>.
