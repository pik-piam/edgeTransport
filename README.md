...
R package **edgeTransport**, version **0.27.3**
...
Dirnaichner A, Rottoli M, Hoppe J (2023). _edgeTransport: Prepare EDGE Transport Data for the REMIND model_. R package version 0.27.3, <https://github.com/pik-piam/edgeTransport>.
