...
R package **edgeTransport**, version **2.12.4**
...
Hoppe J, Dirnaichner A, Rottoli M, Muessel J (2024). "edgeTransport: Prepare EDGE Transport Data for the REMIND model." Version: 2.12.4, <https://github.com/pik-piam/edgeTransport>.
