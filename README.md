...
R package **edgeTransport**, version **2.14.2**
...
Hoppe J, Dirnaichner A, Rottoli M, Muessel J, Hagen A (2025). "edgeTransport: Prepare EDGE Transport Data for the REMIND model." Version: 2.14.2, <https://github.com/pik-piam/edgeTransport>.
