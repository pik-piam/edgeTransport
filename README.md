...
R package **edgeTransport**, version **1.5.3**
...
Dirnaichner A, Rottoli M, Hoppe J (2024). _edgeTransport: Prepare EDGE Transport Data for the REMIND model_. R package version 1.5.3, <https://github.com/pik-piam/edgeTransport>.
